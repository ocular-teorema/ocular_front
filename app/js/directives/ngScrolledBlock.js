    ...
    return {
        ...
        'link': function ($scope, element) {
            ...
            var iniAutoScroll = function () {
                if (!defaultParams['activeItem']) return;
                var position = defaultParams['activeItem'].offset()['top'],
                    minPosition = container.offset()['top'],
                    maxPosition = minPosition + defaultParams.containerHeight - defaultParams['activeItem'].outerHeight(true);
